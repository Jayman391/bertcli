...
def test_build_embedding_model(sample_data):
    ...
    embedding_model = factory.build_embedding_model('sentence-transformers/all-MiniLM-L12-v2')
...
def test_build_dim_red_model(sample_data):
    factory = TopicModelFactory()
    factory.upload_data(sample_data)
    dim_red_model = factory.build_dim_red_model('umap', {'n_neighbors': 5, 'n_components': 2})
