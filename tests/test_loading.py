...
def test_load_data(filepath):
    ...
    if filepath.endswith(".csv"):
        ...
        assert (
            BERTcli.global_session.data["text"][2]
        ...
        assert (
            BERTcli.global_session.data["text"][3]
...
def test_load_config():
    ...
    assert (
        BERTcli.global_session.config_topic_model["embedding_model"]
        == "all-MiniLM-L12-v2"
    )
